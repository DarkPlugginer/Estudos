...
public class ExamplePlugin extends JavaPlugin {
    ...
    // Chat packets
    private Reflection.FieldAccessor<String> CHAT_MESSAGE = Reflection.getField("{nms}.PacketPlayInChat", String.class, 0);

    // Explosion packet
    private Class<?> particleClass = Reflection.getClass("{nms}.PacketPlayOutWorldParticles");
    private Reflection.FieldAccessor<String> particleName = Reflection.getField(particleClass, String.class, 0);
    private Reflection.FieldAccessor<Float> particleX = Reflection.getField(particleClass, float.class, 0);
    private Reflection.FieldAccessor<Float> particleY = Reflection.getField(particleClass, float.class, 1);
    private Reflection.FieldAccessor<Float> particleZ = Reflection.getField(particleClass, float.class, 2);
    private Reflection.FieldAccessor<Integer> particleCount = Reflection.getField(particleClass, int.class, 0);
    ...
    private Reflection.FieldAccessor<Object> serverPing = Reflection.getField(serverInfoClass, serverPingClass, 0);
    private Reflection.FieldAccessor<Object> playerSample = Reflection.getField(serverPingClass, playerSampleClass, 0);
    private Reflection.ConstructorInvoker playerSampleInvoker = Reflection.getConstructor(playerSampleClass, int.class, int.class);
